...
function step2<ChildSchema extends StandardSchemaV1<any, number | { length: number }>>(
    res: StandardSchemaV1.Result<GetSchemaOutput<ChildSchema>>,
    n: number,
    op: Symbol,
    message: string,
): StandardSchemaV1.Result<GetSchemaOutput<ChildSchema>> {
    if (res.issues) {
        return res;
    }
...
function lengthHandler<ChildSchema extends StandardSchemaV1<any, number | { length: number }>>(
    ...
    | StandardSchemaV1.Result<GetSchemaOutput<ChildSchema>>
    | Promise<StandardSchemaV1.Result<GetSchemaOutput<ChildSchema>>> {
...
export interface MinSchema<ChildSchema extends StandardSchemaV1<any, number | { length: number }>>
 ...
 */
export function min<ChildSchema extends StandardSchemaV1<any, number | { length: number }>>(
    childSchema: ChildSchema,
    min: number,
    message = "Wrong length",
): MinSchema<ChildSchema> {
...
export interface MaxSchema<ChildSchema extends StandardSchemaV1<any, number | { length: number }>>
    extends StandardSchemaV1<GetSchemaInput<ChildSchema>> {
    type: "max";
    message: string;
    childSchema: ChildSchema;
 ...
 */
export function max<ChildSchema extends StandardSchemaV1<any, number | { length: number }>>(
    childSchema: ChildSchema,
    max: number,
    message = "Wrong length",
): MaxSchema<ChildSchema> {
...
export interface LengthEqSchema<ChildSchema extends StandardSchemaV1<any, { length: number }>>
    extends StandardSchemaV1<GetSchemaInput<ChildSchema>> {
    type: "lengthEq";
    message: string;
    childSchema: ChildSchema;
 ...
 */
export function lengthEq<ChildSchema extends StandardSchemaV1<any, { length: number }>>(
    childSchema: ChildSchema,
    length: number,
    message = "Wrong length",
): LengthEqSchema<ChildSchema> {
