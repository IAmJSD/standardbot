...
export interface UnionSchema<T extends readonly StandardSchemaV1[]> extends StandardSchemaV1<GetSchemaOutput<T[number]>> {
    type: "union";
    schemas: T;
}
...
export function intersection<Schemas extends readonly StandardSchemaV1[]>(...schemas: Schemas): IntersectionSchema<Schemas>;
