...
test(
    "uuidV4",
    () =>
        testGenericSchema(uuidV4(), [
            "ab6fa8de-bc4c-4432-80d0-62cfbe9acbdc",
            "1cbcc3a7-73cf-4204-bca4-ff30dc2518a4",
        ]),
);
...
test(
    "uuidV5",
    () =>
        testGenericSchema(uuidV5(), [
            "49cd38c3-cb1f-5228-bc2c-2772a5d8afd4",
            "c2f87ef0-d5fe-56cf-95f3-92377ce50b66",
        ]),
);
