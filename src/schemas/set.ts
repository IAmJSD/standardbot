...
export interface SetSchema<ChildSchema extends StandardSchemaV1, AcceptArrays extends boolean = false> extends StandardSchemaV1<
    AcceptArrays extends true ? GetSchemaInput<ChildSchema>[] | Set<GetSchemaInput<ChildSchema>> : Set<GetSchemaInput<ChildSchema>>,
 ...
 */
export function set<ChildSchema extends StandardSchemaV1, AcceptArrays extends boolean = false>(opts: SetSchemaOpts<ChildSchema, AcceptArrays>, message = "Not a valid set"): SetSchema<ChildSchema, AcceptArrays> {
