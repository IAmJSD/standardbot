...
export interface TSEnumSchema<
    Key extends string | number | symbol,
    Output extends string | number | symbol
 ...
 */
export function tsEnum<Key extends string | number | symbol, Output extends string | number | symbol>(values: Record<Key, Output>, message = "Not a valid enum value"): TSEnumSchema<Key, Output> {
 ...
 */
export function enumSchema<Output extends string | number | symbol, Items extends readonly Output[]>(items: Items, message = "Not a valid enum value"): EnumSchema<Items[number]> {
