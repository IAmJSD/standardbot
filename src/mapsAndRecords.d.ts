 ...
 */
export function clonedRecord<
    KeySchema extends StandardSchemaV1<any, string | number | symbol>,
    ValueSchema extends StandardSchemaV1,
>(keySchema: KeySchema, valueSchema: ValueSchema, message?: string): ClonedRecordSchema<KeySchema, ValueSchema>;
 ...
 */
export function mutatedRecord<
    KeySchema extends StandardSchemaV1<any, string | number | symbol>,
    ValueSchema extends StandardSchemaV1,
>(keySchema: KeySchema, valueSchema: ValueSchema, message?: string): MutatedRecordSchema<KeySchema, ValueSchema>;

export interface ClonedMapSchema<KeySchema extends StandardSchemaV1, ValueSchema extends StandardSchemaV1>
...
>(
    ...
    convertObjectToMap?: boolean,
    message?: string,
): ClonedMapSchema<KeySchema, ValueSchema>;

export interface MutatedMapSchema<KeySchema extends StandardSchemaV1, ValueSchema extends StandardSchemaV1>
    extends StandardSchemaV1<Map<GetSchemaOutput<KeySchema>, GetSchemaOutput<ValueSchema>>> {
    type: "mutatedMap";
    keySchema: KeySchema;
    valueSchema: ValueSchema;
...
>(
    ...
    convertObjectToMap?: boolean,
    message?: string,
): MutatedMapSchema<KeySchema, ValueSchema>;
